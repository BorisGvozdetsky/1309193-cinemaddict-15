...
const renderChart = (statsCtx, films) => {
  ...
  statsCtx.height = BAR_HEIGHT * uniqueGenres.length;
...
const createStatsTemplate = (data) => {
  ...
  const alreadyWatchedFilmCount = filmsInPeriod.length;
  ...
  return `<section class="statistic">
    ...
    <ul class="statistic__text-list">
      <li class="statistic__text-item">
        ...
        <p class="statistic__item-text">${alreadyWatchedFilmCount} <span class="statistic__item-description">movies</span></p>
      </li>
      <li class="statistic__text-item">
